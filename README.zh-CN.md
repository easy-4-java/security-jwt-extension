...
[![Java](https://img.shields.io/badge/Java-21-orange)](https://github.com/easy-4-java/security-jwt-extension) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](https://www.apache.org/licenses/LICENSE-2.0.txt)
...
```groovy
implementation 'io.github.easy4j:security-jwt-extension:3.0.x.x.20260630-SNAPSHOT'
```
